...
export default function DashboardLayout() {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    { name: 'Company Expenses', path: '/dashboard/expenses', icon: DollarSign, requiredPermission: Permission.SETTINGS_UPDATE, adminOnly: true },
    { name: 'Pricing Rules', path: '/dashboard/pricing-rules', icon: DollarSign, requiredPermission: Permission.SETTINGS_UPDATE, adminOnly: true },
    { name: 'WeVentureHub Settings', path: '/dashboard/settings', icon: Settings, requiredPermission: Permission.SETTINGS_UPDATE },
